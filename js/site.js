...
//        ] );
        ...
        if ( matrix.solve() === true ) {
            ...
            for (var k = 0; k < loadedMatrixes.length - 1; k++) {
                ...
                this.$result
                    .append( this._buildTitle( 'Загруженная матрица №', k + 1 ) )
                    .append( this._buildTable( lm.loadedMatrix, 0, 0 ) )
                    .append( this._buildTitle( 'Матричные циклы №', k + 1 ) )
                    .append( this._buildLoops( lm.positiveLoopIndex, lm.loops, matrix ) )
                    .append( this._buildTitle( 'Z<sub>min</sub> на матрице №', k + 1 ) )
                    .append( this._buildZMin( lm.zMin, lm.loadedMatrix, matrix ) )
                    .append( this._buildTitle( '&#952;<sub>min</sub> на матрице №', k + 1 ) )
            ...
            this.$result
                .append( this._buildTitle( 'Загруженная матрица №', loadedMatrixes.length ) )
                .append( this._buildTable( lmf.loadedMatrix, 0, 0 ) )
                .append( this._buildTitle( 'Матричные циклы №', loadedMatrixes.length ) )
                .append( this._buildLoops( lmf.positiveLoopIndex, lmf.loops, matrix ) )
                .append( this._buildTitle( 'Z<sub>0</sub> задачи' ) )
                .append( result )
